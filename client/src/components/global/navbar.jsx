              ...
              <div className="hidden lg:flex items-center space-x-4 flex-shrink-0 ">
                {!userRole ? (
                 ...
                 <Link to={'/login&signup'}>
                    ...
                    >
                      <span className="absolute inset-0 bg-gradient-to-r from-[#348559] via-[#09533d] to-[#113a39] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></span>
                    ...
                    {!userRole ? (
                      ...
                      <Link to={'/ConsultantSignupForm'}>
                        <button
                          ...
                          className="bg-[#09533d] text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                          Become a Consultant
                        </button>
                      </Link>
