      ...
      <header className="relative backdrop-blur-xl bg-white/5 border-b border-white/10 shadow-2xl">
        <div className="p-6 flex items-center justify-center space-x-4">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-emerald-300/80 font-medium animate-fade-in">Your AI Assistant • Online</p>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-white/60 animate-fade-in">
              Press <span className="text-emerald-400 font-semibold">Enter</span> to send • <span className="text-emerald-400 font-semibold">Shift + Enter</span> for new line
            </p>
          </div>
        </div>
